...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#0A0A0F] border-b border-[#1E1E2E]">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-6">
          <Link href="/" className="text-lg font-serif font-normal text-white tracking-tight">
            Cloud Vento
          </Link>
            ...
            <div ref={searchRef} className="relative">
              ...
              {searchOpen && (
                <div className="absolute right-0 top-full mt-2 w-72">
                  <div className="bg-[#111218] border border-[#1E1E2E] rounded-lg p-3 shadow-xl">
